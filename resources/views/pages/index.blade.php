...
@endpush
<div id="page">
<header id="fh5co-header" class="fh5co-cover js-fullheight" role="banner" style="background-image: url({{asset('public/panel/images/hero_1.jpeg')}});" data-stellar-background-ratio="0.5">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-md-pull-4 img-wrap animate-box" data-animate-effect="fadeInLeft">
                <img src="{{asset('public/panel/images/hero_1.jpeg')}}" alt="Free Restaurant Bootstrap Website Template by FreeHTML5.co">
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 fh5co-item-wrap animate-box">
                <div class="fh5co-item">
                    <img src="{{asset('public/panel/images/gallery_9.jpeg')}}" class="img-responsive" alt="Free Restaurant Bootstrap Website Template by FreeHTML5.co">
            ...
            <div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 fh5co-item-wrap animate-box">
                <div class="fh5co-item">
                    <img src="{{asset('public/panel/images/gallery_7.jpeg')}}" class="img-responsive" alt="Free Restaurant Bootstrap Website Template by FreeHTML5.co">
            ...
            <div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 fh5co-item-wrap animate-box">
                <div class="fh5co-item margin_top">
                    <img src="{{asset('public/panel/images/gallery_6.jpeg')}}" class="img-responsive" alt="Free Restaurant Bootstrap Website Template by FreeHTML5.co">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="fh5co-blog animate-box">
                    <a href="#" class="blog-bg" style="background-image: url({{asset('public/panel/images/gallery_1.jpeg')}});"></a>
                    <div class="blog-text">
            ...
            <div class="col-md-4">
                <div class="fh5co-blog animate-box">
                    <a href="#" class="blog-bg" style="background-image: url({{asset('public/panel/images/gallery_2.jpeg')}});"></a>
                    <div class="blog-text">
                        <span class="posted_on">Feb. 15th 2016</span>
